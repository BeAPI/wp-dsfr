<?php
// FR SHARE
$share_title = ! empty( $args['title'] ) ? $args['title'] : __( 'Partager la page', 'dsfr-theme' );
	...
	<ul class="fr-btns-group">
		<li>
			<a 
				...
				title="<?php esc_attr_e( 'Partager sur Facebook - nouvelle fenêtre', 'dsfr-theme' ); ?>"
				aria-label="<?php esc_attr_e( 'Partager sur Facebook - nouvelle fenêtre', 'dsfr-theme' ); ?>"
				...
				><?php esc_html_e( 'Partager sur Facebook', 'dsfr-theme' ); ?></a>
		</li>
		<li>
			<a
				class="fr-btn--twitter-x fr-btn"
				title="<?php esc_attr_e( 'Partager sur Twitter - nouvelle fenêtre', 'dsfr-theme' ); ?>"
				aria-label="<?php esc_attr_e( 'Partager sur Twitter - nouvelle fenêtre', 'dsfr-theme' ); ?>"
				...
				><?php esc_html_e( 'Partager sur Twitter', 'dsfr-theme' ); ?></a>
		</li>
		<li>
			<a
				class="fr-btn--linkedin fr-btn"
				title="<?php esc_attr_e( 'Partager sur LinkedIn - nouvelle fenêtre', 'dsfr-theme' ); ?>"
				aria-label="<?php esc_attr_e( 'Partager sur LinkedIn - nouvelle fenêtre', 'dsfr-theme' ); ?>"
				...
				><?php esc_html_e( 'Partager sur LinkedIn', 'dsfr-theme' ); ?></a>
		</li>
		<li>
			<a
				class="fr-btn--mail fr-btn"
				href="<?php echo esc_url( sprintf( 'mailto:?subject=%2$s&body=%2$s %1$s', $url, $page_title ) ); ?>"
				title="<?php esc_attr_e( 'Partager par email', 'dsfr-theme' ); ?>"
				aria-label="<?php esc_attr_e( 'Partager par email', 'dsfr-theme' ); ?>"
				target="_blank"
				><?php esc_html_e( 'Partager par email', 'dsfr-theme' ); ?></a>
		</li>
		<li>
			<button class="fr-btn--copy fr-btn" title="<?php esc_attr_e( 'Copier dans le presse-papier', 'dsfr-theme' ); ?>" onclick="navigator.clipboard.writeText(window.location);alert('Adresse copiée dans le presse papier.');"><?php esc_html_e( 'Copier dans le presse-papier', 'dsfr-theme' ); ?></button>
		</li>
	</ul>
</div>