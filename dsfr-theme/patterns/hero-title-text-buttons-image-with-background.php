 ...
 */
?>
<!-- wp:group {"tagName":"header","metadata":{"name":"Hero avec titre, texte, boutons, image et fond","categories":["hero"],"patternName":"dsfr/hero-title-text-buttons-image-with-background"},"align":"full","className":"wp-block-group\u002d\u002dhero","backgroundColor":"background-alt-blue-france","layout":{"type":"constrained"}} -->
