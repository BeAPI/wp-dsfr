...
namespace Beapi\Theme\Dsfr\Helpers\Formatting\Link;

use function Beapi\Theme\Dsfr\Helpers\Formatting\Escape\escape_content_value;
use function Beapi\Theme\Dsfr\Helpers\Formatting\Escape\escape_attribute_value;

/**
 * @usage Beapi\Theme\Dsfr\Helpers\Formatting\Link\get_acf_link( ['field' => ..., 'class' => ...], [ 'before' => '<p>%s', 'after' => '</p>' ] );
 *
...
/**
 * @usage Beapi\Theme\Dsfr\Helpers\Formatting\Link\the_custom_link( ['url' => ..., 'title' => ...], [ 'wrapper' => '<p></p>' ] );
 *
 * @param array $attributes {
 *    Attributes for the acf link markup.
 *
...
/**
 * @usage Beapi\Theme\Dsfr\Helpers\Formatting\Link\get_link( ['href' => ..., 'title' => ...], [ 'wrapper' => '<p>%s</p>' ] );
 *
 * @param array $attributes {
 *    Attributes for the acf link markup.
 *
...
/**
 * @usage Beapi\Theme\Dsfr\Helpers\Formatting\Link\the_link( ['href' => ..., 'title' => ...], [ 'wrapper' => '<p></p>' ] );
 *
 * @param array $attributes {
...
/**
 * @usage Beapi\Theme\Dsfr\Helpers\Formatting\Link\get_acf_link_classes( ['url' => ...], [ 'menu-item'] );
 *
